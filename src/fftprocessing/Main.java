...
public class Main
{
	public static void main(String[] args)
	{
		...
		double[] sine = SignalGenerator.sinusoidalGenerate(frequency,
				sigSize, sampleRate);
		...
		*/
		...
		// Power Display
		System.out.println("thetapower = " + EegPower.calcTheta(fftsine, sampleRate));
		System.out.println("alphapower = " + EegPower.calcAlpha(fftsine, sampleRate));
		System.out.println("betapower = " + EegPower.calcBeta(fftsine, sampleRate));
		System.out.println("gammapower = " + EegPower.calcGamma(fftsine, sampleRate));
